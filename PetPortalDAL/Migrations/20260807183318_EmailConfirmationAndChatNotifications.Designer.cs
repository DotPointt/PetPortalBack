...
namespace PetPortalDAL.Migrations
{
    ...
    [Migration("20260807183318_EmailConfirmationAndChatNotifications")]
    partial class EmailConfirmationAndChatNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.ChatMessageEmailNotificationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ChatMessageEmailNotifications");
                });
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.EmailConfirmationTokenEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmailConfirmationTokenEntities");
                });
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.FavouriteEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.PlacementPaymentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.RespondEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.ChatMessageEmailNotificationEntity", b =>
                {
                    b.HasOne("PetPortalDAL.Entities.ChatMessageEntity", "Message")
                        .WithMany()
            ...
            modelBuilder.Entity("PetPortalDAL.Entities.RespondEntity", b =>
                {
                    ...
                    b.HasOne("PetPortalDAL.Entities.UserEntity", "Responder")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
